...
public class TeacherTimetable extends AppCompatActivity implements View.OnClickListener {
        ...
        mTimetableView.curWeek(1)
                ...
                .callback(new ISchedule.OnItemLongClickListener() {
                    ...
                    public void onLongClick(View v, int day, int start) {
                        Toast.makeText(TeacherTimetable.this,
                                "长按:周" + day  + ",第" + start + "节",
                    ...
                    public void onItemUpdate(FrameLayout layout, TextView textView, TextView countTextView, Schedule schedule, GradientDrawable gd) {
                        ...
                        if(schedule.getName().equals("【广告】")){
                            ...
                            imageView.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    Toast.makeText(TeacherTimetable.this,"进入广告网页链接",Toast.LENGTH_SHORT).show();
                                }
                            });
                        }
                    }
