...
public class BarChartManager {
    ...
    private void initLineChart() {
        ...
        //背景颜色
        mBarChart.setBackgroundColor(Color.parseColor("#66cc99"));
        //是否显示网格背景
...
//        mBarChart.setHighlightFullBarEnabled(false);
        ...
        //设置XY动画效果
        mBarChart.animateY(1300, Easing.EasingOption.Linear);
        mBarChart.animateX(1300, Easing.EasingOption.Linear);
//      不显示描述信息
...
//      设置宽度
        ...
        //设置X轴的刻度数
        final String[] xValues = {"出勤", "缺勤", "迟到", "早退", "请假","请假"};
        String[] yValues = {"0", "10", "20", "30", "40", "50"};
...
//        设置Y轴的最小值和最大值
    ...
    public void showBarChart1(List<BarEntry> yVals, String label, int color) {
        initLineChart();
...
//      设置宽度
        data.setBarWidth(0.3f);
        //设置X轴的刻度数
        final String[] xValues = {"认真", "不认真", "睡觉", "睡觉"};
        String[] yValues = {"0", "10", "20", "30", "40", "50"};
        xAxis.setLabelCount(yVals.size()+1,true);
        xAxis.setDrawLabels(true);
        IAxisValueFormatter xAxisFormatter = new XAxisValueFormatter(xValues);
